                ...
                <nav className="bg-white shadow-md rounded-xl p-4 space-y-4 text-base font-medium flex flex-col justify-between h-full">
                    ...
                    {isScrolled && (
                        <div className="mt-4 text-center">
                            <a
                                href="#"
                                className="inline-block w-full text-indigo-700 hover:text-white hover:bg-indigo-600 px-4 py-2 rounded-md border border-indigo-600 transition text-sm font-semibold"
                            >
                                ↑ Back to Top
                            </a>
                        </div>
